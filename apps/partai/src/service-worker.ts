...
// runtime cache of visited pages so cached parties remain browsable offline.
// Cross-origin requests (Supabase, Clerk) are never intercepted.
...
const NEVER_CACHE = [/^\/masuk/, /^\/daftar/, /^\/onboarding/, /^\/moderasi/];
