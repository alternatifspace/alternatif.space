<script lang="ts">
	// Manifesto editor (P0-06): TipTap with H2/H3, bold, italic, bullet,
	// numbered, blockquote. No image embeds. 200-char minimum is enforced by
	// the wizard; this component only reports content.
