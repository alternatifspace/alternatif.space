...
// Thread list (M0-04, 6.1–6.3): chronological only — the platform is a referee,
// not an amplifier. No engagement-ranked default exists. Shared by the public
// feed (/jelajah) and the signed-in root feed (/) per the TRD v1.5 addendum.
