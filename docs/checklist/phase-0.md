...
- [ ] **12.8** Cloudflare Pages deployment for `partai` + `mufakat` subdomains (env `PUBLIC_CLERK_PUBLISHABLE_KEY`); verify signed-in redirect + cross-subdomain SSO against production Clerk (depends on 1.8)
